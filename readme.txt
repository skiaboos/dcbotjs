...
-- Instructions
Short instructions are given in the main file (index.js), a more detailed documentation will be given aswell.

-- Contents
- Discord bot base including command handler for bigger bots
- Detailed Instructions
- 3 Pre-Made commands to understand the function of discord bots
